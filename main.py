...
# ---------- DATABASE SETUP ----------
# Create cinema.db with Seat table
...
""")
cursor.executemany("""
INSERT OR IGNORE INTO Seat (seat_id, price, taken)
VALUES (?, ?, ?)
""", [
    (1, 250.0, 0),
    (2, 250.0, 0),
...
# Create banking.db with Card table
...
""")
cursor.executemany("""
INSERT OR IGNORE INTO Card (number, cvc, balance)
VALUES (?, ?, ?)
""", [
    (283, 1995, 1000.0),
    (785, 199530, 500.0)
...
if __name__ == "__main__":
    ...
    card = Card(type=card_type, number=int(card_number), cvc=int(card_cvc), holder=card_holder)
